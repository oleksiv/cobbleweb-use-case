...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.toy_creator_listener' => 'getApp_ToyCreatorListenerService',
    ...
    /**
     * Gets the public 'app.toy_creator_listener' shared service.
     *
     * @return \AppBundle\Event\ToyCreator
     */
    protected function getApp_ToyCreatorListenerService()
    {
        return $this->services['app.toy_creator_listener'] = new \AppBundle\Event\ToyCreator();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist'), $this->get('app.toy_creator_listener'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'technical_tests_sfy', 'user' => 'root', 'password' => 'secret', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_e0bae4b5cfe8c8178a58e747ee02aae6d5f9ba17b3f3d371fb5440f21b53d25c');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a0036b06dbaf7.47405964')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'technical_tests_sfy',
            'database_user' => 'root',
